# Hi there, I'm Lina 👋 (aka **LaConstance**)

> *"The local rules govern the macro-chaos."*
...
Compilée, fonctionnelle, scriptée ou web : j'aime choisir l'outil parfait pour le bon niveau d'abstraction.

| Paradigm / Domain | Technologies |
| :--- | :--- |
| **Core & Systems** | `Python` (Numpy, Scipy, Scikit-Learn) • `C` • `Bash/Shell` |
| **Functional & Math** | `Haskell` |
| **Web & Interfaces** | `JavaScript` • `HTML5` • `CSS3` |
...
<p align="center">
  <img src="https://github-readme-stats.shion.dev/api?username=LaConstance&theme=tokyonight&hide_border=false&include_all_commits=false&count_private=false" alt="Stats de LaConstance" height="20%"/>
  <img src="https://streak-stats.demolab.com/?user=LaConstance&theme=tokyonight&hide_border=false" alt="Streak de LaConstance" height="20%"/>
</p>
